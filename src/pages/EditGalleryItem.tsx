...
const EditGalleryItem = () => {
    ...
    const updateMutation = useMutation({
        ...
        onSuccess: () => {
            toast.success("Item galeri berhasil diubah");
            navigate("/admin/gallery");
        },
        onError: (error: Error) => {
            toast.error(error.message || "Gagal untuk mengubah item galeri");
    ...
    if (isLoading) {
        return (
            <div className="min-h-screen bg-gradient-to-br from-background via-secondary/30 to-accent/20 flex items-center justify-center">
                <p className="text-lg">Memuat item galeri...</p>
            </div>
        );
    }
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-background via-secondary/30 to-accent/20 flex items-center justify-center">
                <div className="text-center">
                    <p className="text-lg mb-4">Item galeri tidak ditemukan</p>
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-background via-secondary/30 to-accent/20">
            <div className="container mx-auto px-4 py-8 max-w-3xl">
                ...
                <Card>
                    <CardHeader>
                        <CardTitle className="text-2xl">Edit Item Galeri</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="media">Ganti Media (Opsional)</Label>
                                <Input id="media" type="file" accept={mediaType === "image" ? "image/*" : "video/*"} onChange={(e) => setMediaFile(e.target.files?.[0] || null)} />
                                {mediaFile && (
                            ...
                            {mediaType === "video" && (
                                <div className="space-y-2">
                                    ...
                                    {galleryItem.thumbnail_url && <img src={galleryItem.thumbnail_url} alt="Current thumbnail" className="w-32 h-32 object-cover rounded mb-2" />}
